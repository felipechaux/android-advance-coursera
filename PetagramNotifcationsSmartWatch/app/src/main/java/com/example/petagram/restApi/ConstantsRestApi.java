...
final public class ConstantsRestApi {
    ...
    public static final String KEY_POST_REGISTER_LIKE_PHOTO = "registrar-like-ig";
    public static final String URL_FIREBASE_REGISTER_LIKE_PHOTO = FIREBASE_SERVER_URL+KEY_POST_REGISTER_LIKE_PHOTO;
}
